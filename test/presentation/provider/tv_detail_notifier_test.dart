...
void main() {
  ...
  group('Get Tv Recommendations', () {
    ...
    test('should update recommendation state when data successfully', () async {
      // arrange
      _arrangeUsecase();
      // act
      await provider.fetchTvDetail(tId);
    ...
    test('should update error message when request is Error', () async {
      // arrange
      when(mockGetTvDetail.execute(tId))
          .thenAnswer((_) async => Right(testTvDetail));
      when(mockGetTvRecommendations.execute(tId))
  ...
  group('on Error', () {
    test('should return error when data is unsuccessfull', () async {
      // arrange
      when(mockGetTvDetail.execute(tId))
